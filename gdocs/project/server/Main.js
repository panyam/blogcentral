...
function refreshTracker() {
    var tracker = getActiveTracker()
    if (tracker == null) {
      SpreadsheetApp.getUi().alert("You have not yet created a tracker for this sheet.  Click on Add-ons > Blog Central > Start");
    } else {
...
function showStartDialog() {
  var html = HtmlService.createTemplateFromFile("client/main")
    .evaluate()
    .setTitle("Blog Central - Options"); // The title shows in the sidebar
